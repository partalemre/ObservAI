      ...
      >
        <div className="flex h-full flex-col">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        className="from-primary-400 to-primary-600 absolute top-0 bottom-0 left-0 w-1 rounded-r-full bg-gradient-to-b"
                    ...
                    {!sidebarOpen && !isMobile && (
                      <div className="pointer-events-none absolute left-full z-50 ml-2 rounded bg-gray-800 px-2 py-1 text-xs whitespace-nowrap text-white opacity-0 transition-opacity group-hover:opacity-100">
                        {item.name}
                      </div>
                    )}
                  </Link>
          ...
          <div className="border-t border-white/10 p-4">
            ...
            >
              {(sidebarOpen || isMobile) && <span>ObservAI v1.0</span>}
              <div
                className={cn(
              ...
              >
                ...
                {(sidebarOpen || isMobile) && <span>Online</span>}
              </div>
            </div>
          </div>
        </div>
