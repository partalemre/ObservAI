    ...
    >
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Yoğun Saatler</h3>
            <p className="text-sm text-gray-400">Saatlik ziyaretçi dağılımı</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6 grid grid-cols-3 gap-4">
        <div className="rounded-lg border border-green-500/20 bg-gradient-to-r from-green-500/10 to-green-600/10 p-3">
          <div className="mb-1 text-xs text-green-300">Toplam Ziyaretçi</div>
        ...
        <div className="rounded-lg border border-blue-500/20 bg-gradient-to-r from-blue-500/10 to-blue-600/10 p-3">
          <div className="mb-1 text-xs text-blue-300">Saatlik Ortalama</div>
          <div className="text-lg font-bold text-white">
            {Math.round(avgVisitors)}
          </div>
        </div>

        <div className="rounded-lg border border-amber-500/20 bg-gradient-to-r from-amber-500/10 to-amber-600/10 p-3">
          <div className="mb-1 flex items-center gap-1">
            <TrendingUp className="h-3 w-3 text-amber-400" />
            <div className="text-xs text-amber-300">En Yoğun</div>
          </div>
          <div className="text-lg font-bold text-white">
